...
namespace shop
{
    ...
    public class DonDatHang
    {
       ...
       /// <param name="ret"></param>
        public static void Dondathang_Insert(string ngaytao, string thanhtienhd, string tinhtrangdonhang, string phuongthucthanhtoan, string makh, string tenkh, string sdtkh, string emailkh, string ret)
        {
        ...
        /// <param name="sdtkh"></param>
        /// <param name="emailkh"></param>
        public static void Dondathang_Update(string madondathang, string ngaytao, string thanhtienhd, string tinhtrangdonhang, string phuongthucthanhtoan, string makh, string tenkh, string sdtkh, string emailkh)
        {
        ...
        public static DataTable Thongtin_Dondathang_by_maThanhToan(string tinhtrangdonhang)
        {
