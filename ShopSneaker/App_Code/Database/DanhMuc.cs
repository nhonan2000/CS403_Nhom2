...
namespace shop
{
    ...
    public class DanhMuc
    {
        ...
        public static void DanhMuc_Insert(string tendm,string thutu,string maDMcha, string ret)
        {
        ...
        /// <param name="thutu"></param>
        /// <param name="maDMcha"></param>
        public static void DanhMuc_Update(string madm, string tendm, string thutu, string maDMcha)
        {
