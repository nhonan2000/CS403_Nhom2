...
/// <summary>
/// Summary description for ketnoi_maxacnhan
/// </summary>
public class ketnoi_maxacnhan
{    
    SqlConnection con;
    private void layknoi()
    {
        //khởi tạo giá trị cho đối tượng SqlConnection 
        con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Maxacnhan.mdf;Integrated Security=True");
        con.Open();//mở kết nối
    }
